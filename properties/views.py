...
from .models import Property, PropertyRequest, PropertyImage, PropertyLike, PropertyComment, UserFollow, Chat, Message, CommentLike, Governorate, District
...
class PropertyListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['governorates'] = Governorate.objects.all()
        context['users'] = User.objects.filter(is_active=True)
        context['deals_count'] = Property.objects.filter(is_available=False).count()
        return context
